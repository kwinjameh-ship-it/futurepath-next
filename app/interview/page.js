...
export default function InterviewPage() {
  ...
  const [messages, setMessages] = useState([
    { sender: 'ai', text: 'สวัสดีครับ! ผมคือ AI ผู้สัมภาษณ์ กดปุ่มไมค์ด้านล่าง แล้วแนะนำตัวให้ผมรู้จักหน่อยครับ' },
  ]);
  ...
  useEffect(() => {
    if (!loading && user.name) {
      setHistory([
        { role: 'user',  parts: [{ text: `คุณคือ AI ผู้เชี่ยวชาญด้านการสัมภาษณ์งานและแนะแนวของ FUTUREPATH AI ให้คุณทำหน้าที่สัมภาษณ์ผู้ใช้งานที่ชื่อ ${user.name} โดยให้ถามทีละ 1 คำถาม แล้วรอให้ผู้ใช้งานตอบกลับ หากผู้ใช้งานตอบได้ดีให้กล่าวชื่นชมสั้นๆ แล้วถามคำถามถัดไป` }] },
        { role: 'model', parts: [{ text: 'สวัสดีครับ! ผมคือ AI ผู้สัมภาษณ์ กดปุ่มไมค์ด้านล่าง แล้วแนะนำตัวให้ผมรู้จักหน่อยครับ' }] },
      ]);
