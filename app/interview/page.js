...
export default function InterviewPage() {
  ...
  const [messages, setMessages] = useState([
    { sender: 'ai', text: 'สวัสดีครับ/ค่ะ ฉันคือตัวแทนจากฝ่ายบุคคล (HR) กดปุ่มไมค์ด้านล่าง แล้วเริ่มแนะนำตัวให้เรารู้จักหน่อยครับ/ค่ะ' },
  ]);
  ...
  useEffect(() => {
    if (!loading && user.name) {
      setHistory([
        { role: 'user',  parts: [{ text: `คุณคือ 'เจ้าหน้าที่ฝ่ายบุคคล (HR)' จากบริษัทชั้นนำระดับโลก ให้คุณทำหน้าที่สัมภาษณ์งานผู้ใช้งานที่ชื่อ ${user.name} อย่างมืออาชีพ มีความจริงจังและท้าทาย โดยให้ถามเจาะลึกทีละ 1 คำถามเกี่ยวกับทัศนคติ การแก้ปัญหา หรือไหวพริบในการทำงาน แล้วรอให้ผู้ใช้งานตอบกลับ หากผู้ใช้งานตอบได้ดีให้ยอมรับสั้นๆ แล้วยิงคำถามถัดไปที่ลึกขึ้น` }] },
        { role: 'model', parts: [{ text: 'สวัสดีครับ/ค่ะ ฉันคือตัวแทนจากฝ่ายบุคคล (HR) กดปุ่มไมค์ด้านล่าง แล้วเริ่มแนะนำตัวให้เรารู้จักหน่อยครับ/ค่ะ' }] },
      ]);
