...
ตอบกลับเป็นออบเจกต์ JSON เท่านั้น โครงสร้างนี้: {"Title": "ชื่อสไตล์จุดแข็ง", "Desc": "คำอธิบายสั้นๆ ที่ฟันธง ไม่ใช้คำไม่แน่นอน", "AnalysisDetail": "รายละเอียดเชิงลึกของการวิเคราะห์ ทิศทางแนวโน้มตลาดแรงงาน และคำแนะนำเชิงลึก เขียนอธิบายอย่างละเอียดเจาะลึก 5-7 ประโยค ทุกประโยคต้องฟันธง", "Roadmap": [{"step": 1, "title": "ชื่อก้าว", "desc": "รายละเอียดเชิงลึกว่าต้องทำอะไรบ้างในขั้นตอนนี้ (2-3 ประโยค)"}...ถึง 5], "Edu": [{"t": "อันดับ 1: คณะ... สาขา...", "d": "ขึ้นต้นประโยคด้วยคำว่า 'คุณมี...' แล้วตามด้วยการอธิบายเชิงลึกถึงความสอดคล้องกับทักษะ (2-3 ประโยค) ตามด้วย 'มหาวิทยาลัยชั้นนำ:' พร้อมแนะนำมหาวิทยาลัย 1-2 แห่ง"}...ถึง 5], "Jobs": [{"t": "อันดับ 1: อาชีพ", "d": "ขึ้นต้นประโยคด้วยคำว่า 'คุณมี...' แล้วตามด้วยการอธิบายเชิงลึกว่าทำไมทักษะนี้ถึงจำเป็นต่ออาชีพนี้ (2-3 ประโยค)"}...ถึง 5], "Dev": [{"t": "ทักษะที่ควรฝึก", "d": "คำแนะนำเชิงลึกที่ฟันธงและนำไปใช้ได้จริง"}...ถึง 3], "Refs": [{"t": "ชื่อแหล่งข้อมูลอ้างอิง", "d": "เนื้อหาอ้างอิงที่เกี่ยวข้องกับทักษะนี้"}]}`;
        const res = await fetch('/api/proxy', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
