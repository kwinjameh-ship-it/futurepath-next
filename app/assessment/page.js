...
(ทักษะที่เหลือได้คะแนนต่ำกว่า ไม่นำมาแนะนำอาชีพ)
...
1. อาชีพ (Jobs) และ คณะ (Edu) ทั้ง 5 อันดับ ต้องสอดคล้องกับ Top 3 ทักษะข้างต้นเท่านั้น ห้ามแนะนำอาชีพที่ต้องใช้ทักษะที่ไม่อยู่ใน Top 3 เด็ดขาด
2. ห้ามซ้ำซากเด็ดขาด: อาชีพทั้ง 5 อันดับ "ต้องไม่ซ้ำกัน" และ คณะ/สาขา ทั้ง 5 อันดับ "ต้องเป็นคนละสาขา (หรือคนละคณะ)" ห้ามแนะนำสาขาเดียวกันซ้ำกันในหลายอันดับ เพื่อให้ผู้ใช้มีทางเลือกที่กว้างที่สุด
3. ผสมผสาน Top 3 ทักษะให้เกิดอาชีพที่หลากหลาย แปลกใหม่ ไม่ซ้ำซาก (มีทั้งกระแสหลักและสายเฉพาะทาง)
4. หัวข้อที่ควรฝึก (Dev) "ต้อง" เกี่ยวข้องกับการพัฒนาจุดที่ได้คะแนนน้อยที่สุด (${lowestSkill}) เพื่ออุดช่องโหว่
5. ใช้ภาษาฟันธง ชัดเจน ห้ามใช้คำว่า อาจจะ, น่าจะ, คงจะ, อาจ, บางที
6. ความเป็นธรรมชาติและหลากหลาย (สำคัญมาก): "ห้าม" ใช้โครงสร้างประโยคซ้ำกันในแต่ละข้อ (เช่น ห้ามขึ้นต้นประโยคด้วยคำเดียวกันทุกข้อ) ให้เขียนอธิบายอย่างเป็นธรรมชาติและมีสไตล์การเขียนที่แตกต่างกันไปในแต่ละคณะและอาชีพ
7. สำหรับคณะ (Edu): หัวข้อ (t) ต้องมีรูปแบบ "อันดับ: ชื่อคณะ สาขา (ความเข้ากันได้: X%)" โดยให้ AI ประเมินเปอร์เซ็นต์ความเหมาะสม (80-99%) จากคะแนนรวม ห้ามใส่ชื่อมหาวิทยาลัยในหัวข้อเด็ดขาด! ให้ย้ายชื่อมหาวิทยาลัยไปแนะนำไว้ที่ประโยคสุดท้ายของคำอธิบาย (d)

ตอบกลับเป็นออบเจกต์ JSON เท่านั้น โครงสร้างนี้: {"Title": "ชื่อสไตล์จุดแข็ง", "Desc": "คำอธิบายสั้นๆ ที่ฟันธง ไม่ใช้คำไม่แน่นอน", "AnalysisDetail": "รายละเอียดเชิงลึกของการวิเคราะห์ ทิศทางแนวโน้มตลาดแรงงาน และคำแนะนำเชิงลึก เขียนอธิบายอย่างละเอียดเจาะลึก 5-7 ประโยค ทุกประโยคต้องฟันธง", "MarketData": {"salary": "ช่วงเงินเดือนเริ่มต้นสำหรับเด็กจบใหม่ในไทย (อ้างอิงฐานจริง ไม่เวอร์เกินไป เช่น 18,000 - 25,000 บาท หรือตามสายงานจริง)", "demand": "ความต้องการตลาดในปัจจุบัน (เชิงอธิบายและระบุเปอร์เซ็นต์การเติบโตถ้าเป็นไปได้)"}, "Roadmap": [{"step": 1, "title": "ชื่อก้าว", "desc": "รายละเอียดเชิงลึกว่าต้องทำอะไรบ้างในขั้นตอนนี้ (2-3 ประโยค)"}...ถึง 5], "Edu": [{"t": "อันดับ 1: คณะ(ชื่อคณะ) สาขา(ชื่อสาขา) (ความเข้ากันได้: 98%)", "d": "อธิบายความสอดคล้องกับทักษะอย่างสร้างสรรค์ (2-3 ประโยค) และประโยคสุดท้ายบังคับพิมพ์ว่า 'มหาวิทยาลัยชั้นนำที่แนะนำ: ...'"}...ถึง 5], "Jobs": [{"t": "อันดับ 1: อาชีพ", "d": "อธิบายเชิงลึกอย่างเป็นธรรมชาติว่าทำไมทักษะที่ได้คะแนนสูงสุดของคุณถึงเหมาะสมกับอาชีพนี้ (2-3 ประโยค ห้ามเขียนประโยคซ้ำกับข้ออื่น)"}...ถึง 5], "Dev": [{"t": "ทักษะที่ควรฝึก", "d": "คำแนะนำเชิงลึกที่ฟันธงและนำไปใช้ได้จริงเพื่ออุดช่องโหว่ของทักษะที่ได้คะแนนน้อยที่สุด (2-3 ประโยค)"}...ถึง 3], "Refs": [{"t": "ชื่อแหล่งข้อมูลอ้างอิง", "d": "เนื้อหาอ้างอิงที่เกี่ยวข้องกับทักษะนี้"}]}`;
        const res = await fetch('/api/proxy', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
    ...
    try {
      await fetch(SHEET_WEBAPP_URL, {
        ...
        body: JSON.stringify({ action: 'assessment', name: user.name, email: user.email, matchPct, scores: newScores, aiTitle: topJobTitle, resultData: { ...aiResult, matchPct, scores: newScores } }),
      });
    } catch {}
