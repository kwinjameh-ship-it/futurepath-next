...
export default function GlassNav({ inline = false }) {
  ...
  const navClasses = inline
    ? "flex flex-col items-center justify-center gap-6 py-12 px-3 shrink-0"
    : "fixed z-[950] flex items-center justify-between md:justify-center gap-2 md:gap-6 p-3 md:py-12 md:px-3 left-4 right-4 bottom-4 md:bottom-auto md:right-auto md:left-6 md:top-1/2 md:-translate-y-1/2 md:flex-col";
